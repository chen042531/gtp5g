...
struct gtpv1_hdr_opt_seq{
    __be16  seq_number;
} __attribute__((packed));

struct gtpv1_hdr_opt_npdu{
    __u8    NPDU;
} __attribute__((packed));

struct gtpv1_hdr_opt_next_ehdr_type{
    __u8    next_ehdr_type;
} __attribute__((packed));

struct gtpv1_ie_recovery {
    __u8	type_num;
	__u8	cnt;
}__attribute__((packed));
...
#define GTP_TYPE_ECHO_REQ  1
#define GTP_TYPE_ECHO_RSP  2
#define GTP_TYPE_EMARK     254
#define GTP_TYPE_TPDU      255
